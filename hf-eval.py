...
st.markdown("""
<div style='text-align: center;'>
    Built by Kai. Like this? <a href="https://kailash.london.com/contact">Hire me!</a>
</div>
""", unsafe_allow_html=True)
...
with coll2:
    st.write(
        f"""
            ...
            <a href = 'https://kailash.london.com/'><img src='{website}' style='width: 35px; height: 35px; margin-right: 25px;'></a>
